...
<body>
	...
	<%-- 바깥쪽에 "큰 따옴표가 있는 경우에는  String은 '작은 따옴표로 해준다. --%>
	...
	<%-- 자바의 . 단독으로 사용하는것은 인식하지 못하기 때문에 조심해야 한다. --%>
	
	<h1>5. 문자열 치환</h1>
	<c:set var="str2" >I love chicken.</c:set>
	
	${str2}<br>
	${fn:replace(str2, 'chicken', 'bread')}<br> <%-- 파라미터 3개: 변수, old, new --%>
	...
	<%-- I love chicken. --%>
	<%-- love 추출 --%>
	${fn:substring(str2, 2, 6)}<br>  <%-- 파라미터 3개: 변수, 시작, 끝+1 --%>
